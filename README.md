...
You can edit the source file directly by clicking on the pencil icon. This will automatically create a fork for you so you can make your edits, add a commit message, and propose the changes. This will create a pull request for you. 
